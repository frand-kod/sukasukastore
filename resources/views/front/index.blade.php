            ...
            <section id="category" class="flex flex-col gap-4 px-4">
               ...
               @forelse ($categories as $itemCategory)
                    <a href="{{route('front.category', $itemCategory->slug)}}">
                        ...
                        transition-all duration-300 hover:ring-2 hover:ring-[#FFC700]">
                            ...
                            <div class="flex shrink-0 w-20 h-[90px] overflow-hidden">
                                <img src="{{Storage::url($itemCategory->icon)}}" class="w-full h-full object-cover
                                object-left" alt="thumbnail">
                            </div>
                        </div>
                    </a>
                @empty
                       ...
                       @forelse ($popularShoes as $itemPopularShoe)
                        <div class="swiper-slide !w-fit py-[2px]">
                            <a href="{{route('front.details', $itemPopularShoe->slug )}}">
                                <div class="flex flex-col shrink-0 w-[230px] h-full rounded-3xl gap-[14px] p-[10px]
                                pb-4 bg-white transition-all duration-300 hover:ring-2 hover:ring-[#FFC700]">
                                    <div class="w-[210px] h-[230px] rounded-3xl bg-[#D9D9D9] overflow-hidden">
                                        <img src=" {{ Storage::url($itemPopularShoe->thumbnail) }}" class="w-full
                                        h-full object-cover" alt="thumbnail">
                                    </div>
