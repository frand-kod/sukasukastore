            ...
            <section id="send-payment-to" class="accordion flex flex-col rounded-[20px] p-4 pb-5 gap-5 mx-4 bg-white overflow-hidden transition-all duration-300 has-[:checked]:!h-[66px]">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col gap-[2px]">
                        <p class="font-semibold flex items-center">sukasukastore <img src="{{asset('assets/images/icons/verify.svg')}}" class="ml-1" alt="icon"></p>
                        <p>8008129839</p>
                    </div>
                </div>
                <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-[10px]">
                    ...
                    <p class="leading-[26px]">Kami melindungi data privasi anda dengan baik bantuan Alfa Imut.</p>
                </div>
            </section>
